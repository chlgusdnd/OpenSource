                ...
                for point in handsModule.HandLandmark:
                    ...
                    if point == 8:
                        ...
                        if int(normalizedLandmark.y * 1000) > finger1_right_y:
                            ...
                            print("3", finger2_right_x, finger2_right_y)
                        else:
